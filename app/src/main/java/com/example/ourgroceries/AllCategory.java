...
import com.example.ourgroceries.adapter.AllCategoryAdapter;
import com.example.ourgroceries.adapter.CategoryAdapter;
import com.example.ourgroceries.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(3,R.drawable.ic_cookies));
        allCategoryModelList.add(new AllCategoryModel(4,R.drawable.ic_meat));
        allCategoryModelList.add(new AllCategoryModel(5,R.drawable.ic_fish));
        allCategoryModelList.add(new AllCategoryModel(6,R.drawable.ic_spices));
        allCategoryModelList.add(new AllCategoryModel(7,R.drawable.ic_egg));
        allCategoryModelList.add(new AllCategoryModel(8,R.drawable.ic_juce));
        allCategoryModelList.add(new AllCategoryModel(9,R.drawable.ic_drink));
